---
title: 'What is a bioregion? Bioregionalism on the Internet (Part 1)'
excerpt: What is bioregionalism? What would one find with an internet search? A knave's look at how the internet explains bioregions — and where it falls short.
category: essays
author:
  name: Tom Watson
...
featured: false
cover:
  image: /v5/blog/overgrown-garden.jpg
  caption: An overgrown garden
  hideCaption: true
  palette1: '#D1E9DE'
  palette2: '#9FC7B6'
  palette3: '#4F8A7B'
...
- And random little explanations from odd corners of different sites [one such corner is a year 2000 post on a mailing list](https://www.ibiblio.org/london/links/start-392001/msg00549.html)
...
That random post on a year 2000 mailing list has a great definition of what makes up a bioregion:
...
And only recently did I find this succinct definition from the bioregion.org.uk team in their Twitter bio:
...
And then Raymond Dasmann and Peter Berg (Peter passed in 2011, RIP) seem big in the scene and had [something to say](https://cascadiabioregion.org/what-is-bioregionalism) about what a bioregion is:
...
Dictionaries fail us once again. "Advocacy of the belief that human activity should be largely *restricted* to distinct ecological and geographical regions." (Emphasis is mine.) Human activity restricted? That does not sound accurate nor appealing at all. Wikipedia does a better job than the dictionary: "Bioregionalism is a philosophy that suggests that political, cultural, and economic systems are more sustainable and just if they are organized around naturally defined areas called bioregions." As we read further into our search, we find a palette of different concepts and tenets that self-identified bioregionalists hold as being part of Bioregionalism, including:
...
I promised you a rundown of "bioregion" and "Bioregionalism." You know there are two definitions running around of a bioregion, and that only one links to Bioregionalism. All definitions of 'bioregion' are ecologically focused but only some are trying to tie in the added complexity of human coordination. And Bioregionalism is a movement striving to use bioregions as a key coordinating concept for our lives. Perhaps your curiosity is sated, and it is time for you to continue on your merry way.

However, if you feel inclined, let me invite you, dear reader, deeper into the mysteries of these matters, and [sharing the good word of Bioregionalism](https://github.com/thomasgwatson/alasdos/blob/master/bioregional/bioregion-2).
