    ...
    <Layout pageTitle="Hylo Privacy Policy">
        ...
        <div className="contentContainer">
            ...
            <ul>
                ...
                <li><strong>IP Address</strong>. An Internet Protocol (IP) address is a unique string of numbers that is assigned to your computer by your Internet Service Provider. Web servers automatically identify your computer by its IP address. We will use your IP address to help diagnose problems with our server and to administer our Service.</li>
