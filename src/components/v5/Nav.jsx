...
const MENU_SECTIONS = [
  ...
  },
  {
    ...
    l: [
      ...
      { t: 'Member Guide',         ext: true, href: 'https://hylozoic.gitbook.io/hylo/guides/hylo-user-guide'      },
      { t: 'Steward Guide',        ext: true, href: 'https://hylozoic.gitbook.io/hylo/guides/hylo-steward-guide' },
      { t: 'Documentation',        ext: true, href: 'https://hylozoic.gitbook.io/hylo'                            },
      { t: 'Code',                 ext: true, href: 'https://github.com/hylozoic/hylo'                                 },
    ],
  },
  {
    h: 'Participate',
    l: [
      ...
      { t: 'Donate',                         ext: true, href: 'https://opencollective.com/hylo' },
    ],
  },
  {
    h: 'Agreements',
